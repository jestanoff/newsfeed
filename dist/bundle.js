...
/******/ 	var hotCurrentHash = "44abe33867990ce8e5fc"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var checkGlobal = __webpack_require__(182);
...
/***/ function(module, exports) {
	 ...
	 * of patent rights can be found in the PATENTS file in the same directory.
	 *
	 * @providesModule isTodoInputElement
	 */
	...
	function isTodoInputElement(elem) {
	  var nodeName = elem && elem.nodeName && elem.nodeName.toLowerCase();
	  return nodeName && (nodeName === 'input' && supportedInputTypes[elem.type] || nodeName === 'textarea');
	}

	module.exports = isTodoInputElement;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UsersMacWebsitesReactTodoListNode_modulesReactTransformHmrLibIndexJs2 = (0, _index6.default)({
	    filename: '/Users/mac/websites/react-todo-list/components/App.js',
	    components: _components,
	    locals: [module],
	    imports: [_react3.default]
	});

	var _UsersMacWebsitesReactTodoListNode_modulesReactTransformCatchErrorsLibIndexJs2 = (0, _index4.default)({
	    filename: '/Users/mac/websites/react-todo-list/components/App.js',
	    components: _components,
	    locals: [],
	...
	function _wrapComponent(id) {
	    return function (Component) {
	        return _UsersMacWebsitesReactTodoListNode_modulesReactTransformHmrLibIndexJs2(_UsersMacWebsitesReactTodoListNode_modulesReactTransformCatchErrorsLibIndexJs2(Component, id), id);
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isIterateeCall = __webpack_require__(203),
	    rest = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createPrototypeProxy = __webpack_require__(244);

	var _createPrototypeProxy2 = _interopRequireDefault(_createPrototypeProxy);

	var _bindAutoBindMethods = __webpack_require__(242);

	var _bindAutoBindMethods2 = _interopRequireDefault(_bindAutoBindMethods);

	var _deleteUnknownAutoBindMethods = __webpack_require__(245);

	var _deleteUnknownAutoBindMethods2 = _interopRequireDefault(_deleteUnknownAutoBindMethods);

	var _supportsProtoAssignment = __webpack_require__(101);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createClassProxy = __webpack_require__(243);

	var _createClassProxy2 = _interopRequireDefault(_createClassProxy);

	var _reactDeepForceUpdate = __webpack_require__(240);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Webkit offers a very useful `TodoInput` event that can be used to
	// directly represent `beforeInput`. The IE `TodoInput` event is not as
	// useful, so we don't use it.
	var canUseTodoInputEvent = ExecutionEnvironment.canUseDOM && 'TextEvent' in window && !documentMode && !isPresto();
	...
	var eventTypes = {
	  beforeInput: {
	    ...
	    dependencies: [topLevelTypes.topCompositionEnd, topLevelTypes.topKeyPress, topLevelTypes.topTodoInput, topLevelTypes.topPaste]
	  },
	  compositionEnd: {
	    phasedRegistrationNames: {
	...
	function getNativeBeforeInputChars(topLevelType, nativeEvent) {
	  switch (topLevelType) {
	    ...
	    case topLevelTypes.topKeyPress:
	      /**
	       * If native `TodoInput` events are available, our goal is to make
	       * use of them. However, there is a special case: the spacebar key.
	       * In Webkit, preventing default on a spacebar `TodoInput` event
	       ...
	       *
	       * To avoid this issue, use the keypress event as if no `TodoInput`
	       * event is available.
	       */
	    ...
	    case topLevelTypes.topTodoInput:
	...
	/**
	 * For browsers that do not provide the `TodoInput` event, extract the
	 ...
	 * `TodoInput` or fallback behavior.
	 *
	 * @param {string} topLevelType Record from `EventConstants`.
	 * @param {DOMEventTarget} topLevelTarget The listening component root node.
	 * @param {string} topLevelTargetID ID of `topLevelTarget`.
	 ...
	 *
	 * This event plugin is based on the native `TodoInput` event
	 * available in Chrome, Safari, Opera, and IE. This event fires after
	 * `onKeyPress` and `onCompositionEnd`, but before `onInput`.
	 *
	 * `beforeInput` is spec'd but not implemented in any browsers, and
	 * the `input` event does not provide any useful information about what has
	 * actually been added, contrary to the spec. Thus, `TodoInput` is the best
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getEventTarget = __webpack_require__(64);
	var isEventSupported = __webpack_require__(67);
	var isTodoInputElement = __webpack_require__(129);
	var keyOf = __webpack_require__(13);
	...
	var ChangeEventPlugin = {
	  ...
	  extractEvents: function extractEvents(topLevelType, topLevelTarget, topLevelTargetID, nativeEvent, nativeEventTarget) {
	    ...
	    } else if (isTodoInputElement(topLevelTarget)) {
	  ...
	  extractEvents: function extractEvents(topLevelType, topLevelTarget, topLevelTargetID, nativeEvent, nativeEventTarget) {
	    ...
	    switch (topLevelType) {
	      ...
	      case topLevelTypes.topFocus:
	        if (isTodoInputElement(topLevelTarget) || topLevelTarget.contentEditable === 'true') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _styleJs = __webpack_require__(308);

	var _styleJs2 = _interopRequireDefault(_styleJs);

	var _errorStackParser = __webpack_require__(135);
	...
	var _lib = __webpack_require__(307);
	...
	var RedBox = function (_Component) {
	  ...
	  RedBox.prototype.render = function render() {
	    ...
	    if (parseError) {
	      frames = React.createElement('div', { style: frame, key: 0 }, React.createElement('div', null, parseError.message));
	    } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createReporter() {
	  var strip = __webpack_require__(310);
	...
	var processUpdate = __webpack_require__(313);
